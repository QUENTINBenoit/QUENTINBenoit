...
Je suis développeur PHP/Symfony et en formation ReactJS  
Ci dessous quelques projets que j'ai realisé.   
La partie front de mes projets sont realisée avec Bootstrap et Twig.  
Apres ma formation ReactJS j'ai l'intention de réaliser le front de mes applications via un API 
